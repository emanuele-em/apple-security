...
use apple_security_sys::key::SecKeyGetTypeID;
use apple_security_sys::base::SecKeyRef;

#[cfg(any(feature = "OSX_10_12", target_os = "ios"))]
pub use apple_security_sys::key::Algorithm;
...
#[cfg(any(feature = "OSX_10_12", target_os = "ios"))]
use apple_security_sys::item::kSecAttrApplicationLabel;
use std::fmt;
...
impl KeyType {
    ...
    #[must_use]
    pub fn ec() -> Self {
        use apple_security_sys::item::kSecAttrKeyTypeEC;
...
impl SecKey {
    ...
    pub fn verify_signature(&self, algorithm: Algorithm, signed_data: &[u8], signature: &[u8]) -> Result<bool, CFError> {
        use apple_security_sys::key::SecKeyVerifySignature;
        let mut error: CFErrorRef = std::ptr::null_mut();
...
impl GenerateKeyOptions {
    ...
    pub fn to_dictionary(&self) -> CFDictionary {
        #[cfg(target_os = "macos")]
        use apple_security_sys::item::kSecUseKeychain;
        use apple_security_sys::item::{
        ...
        match &self.location {
            ...
            Some(Location::DataProtectionKeychain) => {
                use apple_security_sys::item::kSecUseDataProtectionKeychain;
